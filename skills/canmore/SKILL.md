...
3. `canmore_medium_event` to record user interactions or plugin signals.
4. `canmore_medium_read` to read compact state and events.
5. `canmore_medium_promote` only when the surface is worth keeping.
